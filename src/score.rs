...
mod tests {
    ...
    fn get_scores(query: &str, choices: &[&str]) -> Vec<f32> {
        ...
        for choice in choices.iter() {
            result.push(Score::score(query, *choice))
        }
        result
    }
    ...
    fn non_matching(b: &mut Bencher) {
        b.iter(|| {
            Score::score("xxxxxxxxxxxxxxxx", "yyyyyyyyyyyyyyyy")
        })
    }

    #[bench]
    fn matching_exactly(b: &mut Bencher) {
        b.iter(|| {
            Score::score("xxxxxxxxxxxxxxxx", "xxxxxxxxxxxxxxxx")
        })
    }

    #[bench]
    fn matching_broken_up(b: &mut Bencher) {
        b.iter(|| {
            Score::score("xxxxxxxxxx", "xyxyxyxyxyxyxyxyxyxy")
        })
    }


    #[bench]
    fn overlapping_matches(b: &mut Bencher) {
        b.iter(|| {
            Score::score("xxxxxxxxxx", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
        })
    }

    #[bench]
    fn almost_overlapping_matches(b: &mut Bencher) {
        b.iter(|| {
            Score::score("xxxxxxxxxx", "xxxxxxxxxyxxxxxxxxxyxxxxxxxxxyxxxxxxxxxy")
        })
    }

    #[bench]
    fn paths_non_matching(b: &mut Bencher) {
        b.iter(|| {
            get_scores("xxxxxxxxxxxxxxxx", PATHS)
        })
    }

    #[bench]
    fn paths_empty_query(b: &mut Bencher) {
        b.iter(|| {
            get_scores("", PATHS)
        })
    }
    ...
    #[bench]
    fn paths_trivial_query(b: &mut Bencher) {
        b.iter(|| {
            get_scores("a", PATHS)
        })
    }
    ...
    fn progressive_non_sequential_few(b: &mut Bencher) {
        ...
        b.iter(|| {
            (
                get_scores("x", paths),
                get_scores("xc", paths),
                get_scores("xco", paths),
                get_scores("xcon", paths),
                get_scores("xconf", paths),
            )
        })
    }
    ...
    fn progressive_sequential_many(b: &mut Bencher) {
        ...
        b.iter(|| {
            (
                get_scores("g", paths),
                get_scores("ge", paths),
                get_scores("gem", paths),
                get_scores("gemr", paths),
                get_scores("gemru", paths),
                get_scores("gemrub", paths),
                get_scores("gemruby", paths),
            )
        })
    }
    ...
    fn progressive_non_sequential_many(b: &mut Bencher) {
        ...
        b.iter(|| {
            (
                get_scores("g", paths),
                get_scores("gm", paths),
                get_scores("gmr", paths),
                get_scores("gmru", paths),
                get_scores("gmrub", paths),
                get_scores("gmruby", paths),
            )
        })
    }

    static PATHS: &'static [&'static str] =
        &[
            "./.gem",
            "./.gem/ruby",
            "./.gem/ruby/2.1.0",
