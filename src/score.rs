...
mod tests {
    ...
    fn get_scores(query: &str, choices: &[&str]) -> Vec<f32> {
        ...
        for choice in choices.iter() {
            result.push(score(query, *choice))
        }
        result
    }
    ...
    fn non_matching(b: &mut Bencher) {
        b.iter(|| {
            score("xxxxxxxxxxxxxxxx", "yyyyyyyyyyyyyyyy")
        })
    }
    ...
    fn matching_exactly(b: &mut Bencher) {
        b.iter(|| {
            score("xxxxxxxxxxxxxxxx", "xxxxxxxxxxxxxxxx")
        })
    }
    ...
    fn matching_broken_up(b: &mut Bencher) {
        b.iter(|| {
            score("xxxxxxxxxx", "xyxyxyxyxyxyxyxyxyxy")
        })
    }
    ...
    fn overlapping_matches(b: &mut Bencher) {
        b.iter(|| {
            score("xxxxxxxxxx", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
        })
    }
    ...
    fn almost_overlapping_matches(b: &mut Bencher) {
        b.iter(|| {
            score("xxxxxxxxxx", "xxxxxxxxxyxxxxxxxxxyxxxxxxxxxyxxxxxxxxxy")
        })
    }
